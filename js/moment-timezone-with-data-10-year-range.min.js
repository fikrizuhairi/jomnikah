!function(a, i) {
    ...
    var i, s = {}, c = {}, A = {}, u = {}, m = {}, a = (o && "string" == typeof o.version || D("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/"),
    o.version.split(".")), r = +a[0], e = +a[1];
    function n(a) {
    ...
    function p(a) {
        for (var a = a.split("|"), i = a[2].split(" "), r = a[3].split(""), e = a[4].split(" "), o = (l(i),
        l(r),
        l(e),
        e), c = r.length, A = 0; A < c; A++)
    ...
    function h(a) {
        var i = a.toTimeString()
          , r = i.match(/\([a-z ]+\)/i);
        "GMT" === (r = r && r[0] ? (r = r[0].match(/[A-Z]/g)) ? r.join("") : void 0 : (r = i.match(/[A-Z]{3,5}/g)) ? r[0] : void 0) && (r = void 0),
        this.at = +a,
        this.abbr = r,
    ...
    function E() {
        for (var a, i, r = (new Date).getFullYear() - 2, e = new h(new Date(r,0,1)), o = [e], c = 1; c < 48; c++)
            (i = new h(new Date(r,c,1))).offset !== e.offset && (a = function(a, i) {
                for (var r; r = 6e4 * ((i.at - a.at) / 12e4 | 0); )
                    (r = new h(new Date(a.at + r))).offset === a.offset ? a = r : i = r;
                return a
            }(e, i),
            o.push(a),
    ...
    function z() {
        try {
            ...
            if (a && 3 < a.length) {
                ...
                if (i)
                    return i;
                D("Moment Timezone found " + a + " from the Intl api, but did not have that data loaded.")
            }
        } catch (a) {}
        for (var r, e, o = E(), c = o.length, A = function(a) {
            for (var i, r, e = a.length, o = {}, c = [], A = 0; A < e; A++)
                for (i in r = m[a[A].offset] || {})
                    r.hasOwnProperty(i) && (o[i] = !0);
            for (A in o)
                o.hasOwnProperty(A) && c.push(u[A]);
            return c
        ...
        return n.sort(g),
        0 < n.length ? n[0].zone.name : void 0
    }
    function P(a) {
    ...
    function T(a, i) {
        a = P(a);
        var r = s[a];
        return r instanceof b ? r : "string" == typeof r ? (r = new b(r),
        s[a] = r) : c[a] && i !== T && (i = T(c[a], T)) ? ((r = s[a] = new b)._set(i),
        r.name = u[a],
        r) : null
    }
    function S(a) {
    ...
    function C(a) {
        ...
        D("moment.tz.zoneExists('" + a + "') has been deprecated in favor of !moment.tz.zone('" + a + "')")),
        !!T(a)
    }
    function B(a) {
        var i = "X" === a._f || "x" === a._f;
    ...
    function y(a) {
        ...
        return e && !o.isMoment(a) && B(i) && i.add(e.parse(i), "minutes"),
        i.tz(r),
        i
    }
    (r < 2 || 2 == r && e < 6) && D("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"),
    b.prototype = {
        _set: function(a) {
            this.name = a.name,
            this.abbrs = a.abbrs,
        ...
        parse: function(a) {
            for (var i, r, e, o = +a, c = this.offsets, A = this.untils, n = A.length - 1, t = 0; t < n; t++)
                if (i = c[t],
                r = c[t + 1],
                e = c[t && t - 1],
                i < r && y.moveAmbiguousForward ? i = r : e < i && y.moveInvalidForward && (i = e),
                o < A[t] - 6e4 * i)
                    return c[t];
            return c[n]
        },
    ...
    y.zonesForCountry = function(a, i) {
        var r;
        return r = (r = a).toUpperCase(),
        (a = A[r] || null) ? (r = a.zones.sort(),
        i ? r.map(function(a) {
            return {
                name: a,
    ...
    o.updateOffset = function(a, i) {
        var r, e = o.defaultZone;
        void 0 === a._z && (e && B(a) && !a._isUTC && (a._d = o.utc(a._a)._d,
        a.utc().add(e.parse(a), "minutes")),
        a._z = e),
        a._z && (e = a._z.utcOffset(a),
        Math.abs(e) < 16 && (e /= 60),
        void 0 !== a.utcOffset ? (r = a._z,
        a.utcOffset(-e, i),
        a._z = r) : a.zone(e, i))
    }
    ,
    a.tz = function(a, i) {
        if (a) {
            ...
            return this._z = T(a),
            this._z ? o.updateOffset(this, i) : D("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
            this
        }
        if (this._z)
            return this._z.name
    ...
    o.tz.setDefault = function(a) {
        return (r < 2 || 2 == r && e < 9) && D("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + o.version + "."),
        o.defaultZone = a ? T(a) : null,
        o
    }
    ;
    a = o.momentProperties;
    return "[object Array]" === Object.prototype.toString.call(a) ? (a.push("_z"),
    a.push("_a")) : a && (a._z = null),
    _({
        version: "2023c",
